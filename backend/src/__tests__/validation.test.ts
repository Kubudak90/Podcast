...
describe('Validation Schemas', () => {
  describe('registerSchema', () => {
    it('should accept valid username', () => {
      const result = registerSchema.safeParse({ username: 'testuser' });
      expect(result.success).toBe(true);
    });

    it('should accept username with numbers and underscores', () => {
      const result = registerSchema.safeParse({ username: 'test_user123' });
      expect(result.success).toBe(true);
    });
    ...
    it('should reject username with special characters', () => {
      const result = registerSchema.safeParse({ username: 'test@user' });
      expect(result.success).toBe(false);
    });
  ...
  describe('loginSchema', () => {
    ...
    it('should reject short username', () => {
      const result = loginSchema.safeParse({ username: 'a' });
      expect(result.success).toBe(false);
    });
  });

...
export function Chat({ roomSlug, isOpen, onClose }: ChatProps) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-80 bg-slate-800 border-l border-slate-700 flex flex-col z-40 safe-area-pr">
      {/* Header */}
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex gap-2">
          <input
            ...
            maxLength={500}
            className="flex-1 px-3 py-2 bg-slate-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
          <button
            onClick={sendMessage}
            disabled={!input.trim()}

...
- Colyseus (oda yönetimi, state sync)
- LiveKit Server SDK (ses altyapısı)
- PostgreSQL (kullanıcı, oda, kayıt metadata)
- Redis (session, cache)
```
...
class Participant extends Schema {
  @type("string") odaId: string;
  @type("string") odaSlug: string;
  @type("string") odaBaslik: string;
  @type("string") odaDurumu: string; // 'bekliyor' | 'canli' | 'bitti'
  @type("string") hostId: string;
  @type("boolean") kayitAktif: boolean;
  @type({ map: Katilimci }) katilimcilar = new MapSchema<Katilimci>();
}

class PodcastRoom extends Schema {
  @type("string") roomId: string;
  @type("string") slug: string;
  @type("string") title: string;
  @type("string") status: string; // waiting | live | ended
  @type("string") hostId: string;
  @type("boolean") isRecording: boolean;
...
- Colyseus sadece oda state sync için, ses LiveKit'ten geçecek
